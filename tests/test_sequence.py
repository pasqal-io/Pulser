...
def test_dmm_declaration(reg, device, det_map):
    ...
    with pytest.raises(ValueError, match=r"No DMM called dmm_2 is available in the device\. Your selected device .* has the following DMM channels available: \['dmm_0', 'dmm_1'\]\."):
