...
class Device(BaseDevice):
    ...
    def to_virtual(self, reusable_channels_to_virtual: bool=True) -> VirtualDevice:
        """Converts the Device into a VirtualDevice.
        
            Args:
                reusable_channels_to_virtual: Sets the value of reusable_channels in the VirtualDevice (default to True) 
        """
        params = self._params()
