...
$$H^\text{int}_{ij} = \frac{C_6}{R_{ij}^6} \hat{n}_i \hat{n}_j = \frac{C_6}{R_{ij}^6} \left( \underset{(1)}{\hat{I}} ... \otimes \underset{(j)}{\hat{n}} ... \otimes \underset{(i)}{\hat{n}} ... \otimes \underset{(N)}{\hat{I}}\right),$$
